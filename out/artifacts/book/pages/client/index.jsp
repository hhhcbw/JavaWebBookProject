    ...
    <div id="book">
        ...
        <div style="text-align: center">
            ...
            <c:if test="${not empty sessionScope.cart.items}">
                ...
                <div>
                    <span style="color: #ff0000" id="cartLastName">您刚刚将${sessionScope.lastName}加入到了购物车中</span>
                </div>
            </c:if>
        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                // 发ajax请求，添加商品到购物车
                $.getJSON("${pageScope.bathPath}cartServlet","action=ajaxAddItem&id=" + bookId, function (data) {
